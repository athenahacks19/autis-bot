...
class checkupDialog extends CancelAndHelpDialog {
    constructor(id) {
        super(id || 'checkupDialog');

        this.addDialog(new TextPrompt(TEXT_PROMPT))
            .addDialog(new ConfirmPrompt(CONFIRM_PROMPT))
            .addDialog(new WaterfallDialog(WATERFALL_DIALOG, [
                this.moodStep.bind(this),
    ...
    async moodStep(stepContext) {
        ...
        if (!moodDetails.mood) {
            return await stepContext.prompt(TEXT_PROMPT, { prompt: 'How are you feeling today?' });
        } else {
            return await stepContext.next(moodDetails.mood);
        }
    }
...
module.exports.checkupDialog = checkupDialog;
